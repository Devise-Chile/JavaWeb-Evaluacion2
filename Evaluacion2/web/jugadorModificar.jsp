        ...
        <center class="uk-container">
            ...
            <form action="ControladorJugador" method="post">
                <fieldset class="uk-fieldset">
                    <div>
                    <legend class="uk-legend">Modificar Jugador</legend>
                    </div><br /><br />
                    <div>
                        ID
                    ...
                    <div>
                        Nombre
                        <input class="uk-input uk-form-width-large" type="text" name="nombre" value="<%= j.getNombre() %>">
                    </div><br />
                    <div>
                        Apellido
                        <input class="uk-input uk-form-width-large" type="text" name="apellido" value="<%= j.getApellido() %>">
                    </div><br />
                    <div>
                        Fecha de Nacimiento
                        <input class="uk-input uk-form-width-large" type="date" name="f_nacimiento" value="<%= j.getFechaNacimiento() %>"/>
                    </div><br />
                    <div>
                        Posición
                        <select name="cod_posicion" class="uk-select uk-form-width-large">
                            ...
                            <% for(Posicion pos: new PosicionDAO().obtenerPosiciones()) { %>
                                <option value="<%= pos.getCodigo()%>" <% if(pos.getCodigo() == j.getPosicion().getCodigo()){ %>selected="selected"<%}%>><%= pos.getNombre() %></option>
                            <% } %>
                        </select>
                    </div><br />
                    <div>
                        Sueldo
                        <input class="uk-input uk-form-width-large" type="number" name="sueldo" value="<%= j.getSueldo() %>">
                    </div><br />
                    <div>
                        Equipo
                        <select name="cod_equipo" class="uk-select uk-form-width-large">
                            ...
                            <% for(Equipo e: new EquipoDAO().obtenerEquipos()) { %>
                                <option value="<%= e.getCodigo()%>" <% if(e.getCodigo() == j.getEquipo().getCodigo()){ %>selected="selected"<%}%>><%= e.getNombre() %></option>
                            <% } %>
                        </select>
                    </div><br />
